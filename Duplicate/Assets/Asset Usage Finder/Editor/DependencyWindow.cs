...
namespace AssetUsageFinder {
    class DependencyWindow : EditorWindow {
        ...
        public static Style StyleInstance => AssetUsageFinder.Singleton<Style>.GetOrCreate(Style.FindSelf);
        ...
        public void Init(DependencyAbstractFinder d) {
            ...
            _rowPropWidth = CalculateContentMaxWidth(EditorStyles.label,
                _data.Target.Nested.Union(new[] {_data.Target.Root}).Where(o => o).Select(o => new GUIContent((o is ScriptableObject || o is MonoScript) ? o.ToString() : o.name)));
        ...
        Dictionary<int, bool> _showDeeper = new Dictionary<int, bool>();
        ...
        static float CalculateContentMaxWidth(GUIStyle rowStyle, IEnumerable<GUIContent> guiContents) {
            var maxWidth = 0f;
